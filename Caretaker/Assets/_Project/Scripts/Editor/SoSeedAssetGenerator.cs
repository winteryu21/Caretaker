...
namespace Caretaker.Editor
{
    ...
    public static class SoSeedAssetGenerator
    {
        ...
        private static readonly RoomBaseSeed[] ROOM_BASE_SEEDS =
        {
            ...
            new("A_1F_SECURITY_HALL", "A동 1F 보안실 앞 복도", new[] { "A_1F_LOBBY", "A_B1_SUBSTATION_HALL", "A_1F_SECURITY_ROOM" }),
            new("A_1F_SECURITY_ROOM", "A동 1F 보안실", new[] { "A_1F_SECURITY_HALL" }),
            new("A_2F_DIRECTOR_OFFICE", "A동 2F 연구소장실", new[] { "A_2F_HALL" }),
            new("A_2F_HALL", "A동 2F 2층 복도", new[] { "A_2F_DIRECTOR_OFFICE", "A_TO_B_SKYBRIDGE" }),
            new("A_TO_B_SKYBRIDGE", "구름다리", new[] { "A_2F_HALL", "B_2F_ARCHIVE" }),
            new("B_2F_ARCHIVE", "B동 2F 자료실", new[] { "A_TO_B_SKYBRIDGE", "B_1F_LAB" }),
            new("B_1F_LAB", "B동 1F 실험실", new[] { "B_2F_ARCHIVE", "B_1F_SAMPLE_STORAGE" }),
            new("B_1F_SAMPLE_STORAGE", "B동 1F 샘플 저장고", new[] { "B_1F_LAB" }),
