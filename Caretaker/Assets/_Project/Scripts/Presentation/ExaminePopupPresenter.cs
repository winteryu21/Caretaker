...
namespace Caretaker.Presentation
{
    ...
    public sealed class ExaminePopupPresenter : MonoBehaviour
    {
        ...
        /// </summary>
        /// <param name="title">팝업 제목입니다.</param>
        /// <param name="body">팝업 본문입니다.</param>
        /// <param name="image">선택적 조사 이미지입니다.</param>
        public void Open(string title, string body, Sprite image)
        {
            ...
            if (_bodyText != null)
            {
                ...
                bodyRect.anchorMin = new Vector2(image != null ? 0.45f : 0f, 0f);
                bodyRect.offsetMin = new Vector2(image != null ? 12f : 32f, 76f);
            }
